      ...
      <form id="login-form" onsubmit="return false">
        ...
        <label class="login-account-wrapper">
          ...
          <input
            ...
            name="account"
            type="text"
            placeholder="${ opts.accountLabelHolder }"
            maxlength="${ opts.accountMax }"
            autocomplete="${ opts.autocompleteValue }"
          >
         ...
         <label class="login-password-wrapper">
           ...
           <input
             ...
             name="password"
             type="password"
             placeholder="${ opts.passwordLabelHolder }"
             maxlength="${ ops.passwordMax }"
          ...
          <label class="login-remember-wrapper" style="display: ${ showRemember }">
            <span>记住密码：</span>
            <input id="login-remember" name="remember" type="checkbos">
          </label>
...
export default (conf) => {
  conf.contsiner.innerHTML = tpl(conf);
